...
Spring Security是Spring家族中的一个安全管理框架,相比与另外一个安全框架**Shiro**,它提供了更丰富的功能,社区资源也比Shiro丰富<img src="./images/%E4%BC%A0%E9%80%81%E9%97%A8.png" alt="传送门" style="zoom:10%;" align="right"/>
...
![image-20230515122204230](./images/image-20230515122204230.png)

启动SpringBoot后控制台自动打印password

![image-20230515111742527](./images/image-20230515111742527.png)

输入账号，密码后进入页面内

![image-20230515111838401](./images/image-20230515111838401.png)
...
![image-20230515122335159](./images/image-20230515122335159.png)

点击后退出到登录页面

![image-20230515122409008](./images/image-20230515122409008.png)
...
![image-20211215094003288](./images/image-20211215094003288-1684293988758-1.png)
...
#### 2.2.1 SpringSecurity完整流程:pager: 

SpringSecurity的原理其实就是一个<ins style="color:red">过滤器链</ins>，内部包含了提供各种功能的过滤器，这里我们可以看看入门案例中的过滤器。

![image-20230515125451221](./images/image-20230515125451221.png)
...
![image-20230515131823600](./images/image-20230515131823600.png)

#### 2.2.2 认证流程详解:japanese_castle: 

![image-20230515135851738](./images/image-20230515135851738.png)
...
![image-20230515140642377](./images/image-20230515140642377.png)

**思考**：Jwt认证过滤器中从获取到了userid后怎么获取到完整的用户信息？

![image-20230515140959180](./images/image-20230515140959180.png)

![image-20230515143734436](./images/image-20230515143734436.png)
...
![image-20230516174146080](./images/image-20230516174146080.png)

<font style="color:red">不加{noop}登录后端就会报错如下</font>：

![image-20230516174034569](./images/image-20230516174034569.png)

这样登录的时候就可以用123作为用户名，123作为密码了登录了。

![image-20230516174127584](./images/image-20230516174127584.png)
...
![image-20230520205719441](./images/image-20230520205719441.png)
...
所以我们可以先写一个mapper，其中提供一个方法可以根据userid查询权限信息。
...
![image-20230518143620414](./images/image-20230518143620414.png)

**PostMan结果**：

![image-20230518143302423](./images/image-20230518143302423.png)

**测试认证失败场景**：

只需要将用户名请求过去一个数据库中不存在的即可。

![image-20230518143449553](./images/image-20230518143449553.png)
